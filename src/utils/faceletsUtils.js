/**
 * Facelets conversion utilities
 * Converted from gan-cube-sample/src/utils.ts
 */

import { cube3x3x3 } from 'cubing/puzzles';
import { KPattern, KPuzzle } from 'cubing/kpuzzle';

let KPUZZLE_333 = null;
 ...
 */
export function patternToFacelets(pattern) {
 ...
 * @returns Promise that resolves to KPattern object representing cube state
 */
export async function faceletsToPattern(facelets) {
  // Wait for KPuzzle to be initialized if needed
  if (!KPUZZLE_333) {
